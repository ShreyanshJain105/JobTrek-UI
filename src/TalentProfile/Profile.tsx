...
const Profile=(props:any)=>{
    return <div className="w-2/3">
        ...
        <div className="px-3 mt-16 ">
                ...
                <div className="text-xl flex flex gap-1 items-center"><IconBriefcase className="h-5 w-5 " stroke={1.5}/>{props.role} &bull; {props.company}</div>
            ...
            <div className="px-3">
                ...
                <div className="text-sm  text-mine-shaft-300 text-justify">{props.about}
