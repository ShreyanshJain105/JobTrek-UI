    ...
    return <div className="bg-mine-shaft-900 p-4 w-72 flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400 ">
        ...
        <div className="flex justify-between">
            ...
            <div className=" p-1 flex gap-1 text-xs test-mine-shaft-400 items-center">
                <IconClockHour3 className="h-5 w-5 " stroke={1.5} /> <span className="leading-5">{props.applied || props.interviewing ? "Applied" : props.offered ? "Interviewed" : "posted"} {timeAgo(props.postTime)}</span>
            </div>
        </div>
