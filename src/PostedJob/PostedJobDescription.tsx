                            ...
                            <Tabs.Panel value="applicants">
                                <div className="flex mt-10 flex-wrap justify-around">
                                    ...
                                    {arr?.length
                                        ...
                                        )): <div className="text-2xl font-semibold">No applicants available</div>}
                                </div>
                            </Tabs.Panel>
                                ...
                                <div className="flex mt-10 flex-wrap gap-5 justify-around">
                                    {
                                        arr?.length
                                            ...
                                            : <div className="text-2xl font-semibold">No candidates invited </div>
                                    }
                                </div>
                            </Tabs.Panel>
                            ...
                            <Tabs.Panel value="offered">
                                <div className="flex mt-10 flex-wrap gap-5 justify-around">
                                    {arr?.length
                                        ...
                                        )): <div className="text-2xl font-semibold">No offers available </div>}
                                </div>
                            </Tabs.Panel>
                            ...
                            <Tabs.Panel value="rejected">
                                <div className="flex mt-10 flex-wrap gap-5 justify-around">
                                    {arr?.length
                                        ...
                                        )): <div className="text-2xl font-semibold">No candidates rejected  </div>}
                                </div>
                            </Tabs.Panel>
                        </Tabs>
                    </div>
