...
import { IconBookmark, IconBookmarkFilled, IconClockHour3, IconEdit } from "@tabler/icons-react";
...
const JobCard = (props: any) => {
    ...
    return <div className="bg-mine-shaft-900 p-4 w-72 sm-mx:w-full flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400 ">
            ...
            <div className="flex gap-2 items-center">
                ...
                <div>
                    ...
                    <div className="text-xs text-mine-shaft-300"><Link
                        className="hover:text-mine-shaft-200" to="/company">{props.company}</Link>
        ...
        <div className="flex justify-between">
            ...
            <div className=" p-1 flex gap-1 text-xs test-mine-shaft-400 items-center">
                <IconClockHour3 className="h-5 w-5 " stroke={1.5} /> <span className="leading-5">Posted {timeAgo(props.postTime)} </span>
            </div>
        </div>
        <Link to={`/jobs/${props.id}`}>
            <Button
                ...
                fullWidth
                color="brightSun.4" variant="outline" >View Job
            </Button></Link>
    </div>
}
